...
namespace Client.MirScenes
{
    ...
    public sealed class GameScene : MirScene
    {
        ...
        public Color GradeNameColor(ItemGrade grade)
        {
            switch (grade)
            {
                case ItemGrade.Uncommon: //callisto edit from Common
                    return Color.Yellow;
                case ItemGrade.Rare:
        ...
        public MirControl NameInfoLabel(UserItem item, bool Inspect = false)
        {
            ...
            MirLabel nameLabel = new MirLabel
            {
                ...
                OutLine = true,
                Parent = ItemLabel,
                Text = HoverItem.Info.Grade != ItemGrade.Common ? HoverItem.Info.FriendlyName + "\n" + HoverItem.Info.Grade.ToString() :  //Callisto edited from None
