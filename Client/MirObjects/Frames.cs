...
namespace Client.MirObjects
{
    public class FrameSet
    {
        ...
        static FrameSet()
        {
            ...
            frame.Frames.Add(MirAction.Attack3, new Frame(328, 5, 0, 100));
            frame.Frames.Add(MirAction.Attack4, new Frame(368, 8, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(192, 3, 0, 200));
            ...
            frame.Frames.Add(MirAction.Attack2, new Frame(248, 6, 0, 100)); //halfmoon????
            frame.Frames.Add(MirAction.Struck, new Frame(160, 2, 0, 200));
            ...
            frame.Frames.Add(MirAction.Attack3, new Frame(344, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack4, new Frame(392, 8, 0, 100));
