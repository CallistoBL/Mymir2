...
namespace Client.MirObjects
{
    public class PlayerObject : MapObject
    {
        ...
        public MLibrary WeaponLibrary1, WeaponEffectLibrary1, WeaponLibrary2, HairLibrary, WingLibrary, MountLibrary; //callisto added weaponeffect
        public int Armour, Weapon, WeaponEffect, ArmourOffSet, HairOffSet, WeaponOffSet, WingOffset, MountOffset; //callisto added weaponeffect
        ...
        public void Load(S.ObjectPlayer info)
        {
            ...
            Weapon = info.Weapon;
            WeaponEffect = info.WeaponEffect;//callisto added weaponEffect
            Armour = info.Armour;
            Light = info.Light;
        ...
        public void DrawWeapon()//callisto added weaponEffect
        {
            if (Weapon < 0) return;
